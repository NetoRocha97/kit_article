...
│   └── Experiment/                                                    # Specific directory for the experiment execution
│       ├── .RData                                                     # R workspace data (saved variables and objects)
│       ├── .Rhistory                                                  # History of executed R commands
│       ├── .Rproj.user/                                               # RStudio project-specific configuration files
│       ├── README.md                                                  # Documentation describing the Experiment folder contents
│       ├── Step_5.Rproj                                               # RStudio project file used to manage and organize the experiment
...
│       └── reports/                                                   # Reports and analyses generated throughout the experiment
