...
theme_set(theme_bw())
prs_characterization <- read.csv("../data/filtered_opennlp_prs_characterization.csv")
...
```{r}
data.frame(repo = c("opennlp"), NCLOC = c(440441, 318428, 67690, 30501, 95929, 189487, 76964, 110481, 155900, 234331, 251505, 131712), classes = c(5164, 4716, 839, 288, 918, 2106, 879, 3036, 2478, 3419, 5254, 1542))
```
